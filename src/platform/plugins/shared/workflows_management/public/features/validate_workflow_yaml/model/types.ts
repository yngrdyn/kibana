...
interface YamlValidationResultTriggerReentryWarning extends YamlValidationResultBase {
  severity: YamlValidationErrorSeverity;
  message: string;
...
export type YamlValidationResult =
  ...
  | YamlValidationResultTriggerReentryWarning
